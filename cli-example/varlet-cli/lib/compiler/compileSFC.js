        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    // script
                    return [4 /*yield*/, compileScript_1.compileScript(content, sfc)
                        // style
                    ];
                case 2:
                    // script
                ...
                case 3:
                    ...
                    style = styles[index];
                    file = fsUtils_1.replaceExt(sfc, "Sfc" + (index || '') + "." + (style.lang || 'css'));
                    code = compiler_sfc_1.compileStyle({
                        source: style.content,
                        filename: file,
                        id: scopeId,
                        scoped: style.scoped,
                    }).code;
                    code = compileStyle_1.extractStyleDependencies(file, code, compileStyle_1.STYLE_IMPORT_RE, style.lang, true);
                    fs_extra_1.writeFileSync(file, compileStyle_1.clearEmptyLine(code), 'utf-8');
                    _a = style.lang === 'less';
