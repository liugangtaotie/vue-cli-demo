    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    spinner = ora_1.default('prettier starting...').start();
                    return [4 /*yield*/, execa_1.default('prettier', ['--write', '.'])];
                case 1:
                    _a.sent();
                    spinner.succeed('prettier success');
                    spinner = ora_1.default('stylelint starting...').start();
                    stylelintPattern = ['./src/**/*.vue', './src/**/*.css', './src/**/*.less'];
                    hasPackages = fsUtils_1.isDir(path_1.resolve(constant_1.CWD, 'packages'));
                    hasPackages && stylelintPattern.push('./packages/**/*.vue', './packages/**/*.css', './packages/**/*.less');
                    return [4 /*yield*/, execa_1.default('stylelint', __spreadArray(__spreadArray([], __read(stylelintPattern)), ['--fix']))];
                case 2:
                    _a.sent();
                    spinner.succeed('stylelint success');
                    spinner = ora_1.default('eslint starting...').start();
                    eslintPatterns = [
                        './src',
                    ...
                    return [4 /*yield*/, execa_1.default('eslint', __spreadArray(__spreadArray([], __read(eslintPatterns.filter(function (pattern) { return fsUtils_1.isDir(path_1.resolve(constant_1.CWD, pattern)); }))), [
                            '--fix',
                            '--ext',
