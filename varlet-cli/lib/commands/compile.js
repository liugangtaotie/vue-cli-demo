...
function removeDir() {
    return Promise.all([fs_extra_1.remove(constant_1.ES_DIR), fs_extra_1.remove(constant_1.HL_DIR), fs_extra_1.remove(constant_1.UMD_DIR)]);
}
...
function runTask(taskName, task) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    s = ora_1.default().start("Compiling " + taskName);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, task()];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, runTask('umd', function () { return compileModule_1.compileModule('umd'); })];
                case 3:
                    _a = (_b.sent());
                    _b.label = 4;
                case 4:
